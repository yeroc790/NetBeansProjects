...
public class Sale {
    ...
    /*
        Returns true if the names are the same and the bill for the calling object is equal to the bill for otherSale; otherwise returns false.
    ...
    */
    ...
    /*
        Returns true if the bill for the calling object is less than the bill for otherSale; otherwise returns false
    */
